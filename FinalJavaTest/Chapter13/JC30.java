package FinalJavaTest.Chapter13;
...
class MymyLabel extends JLabel {
    ...
    synchronized public void fill() {
        ...
        //notify(); // 기다리는 MyConsumerThread 스레드 깨우기
    }
...
class MyConsumerThread implements Runnable {
    ...
    public MyConsumerThread(MyLabel bar, int sT) {
        this.bar = bar;
        sleepTime = sT;
    }
...
class MyTimerRunnable implements Runnable {
    ...
    public MyTimerRunnable(JLabel timerLabel) {
...
// JFrame을 상속받는 메인 클래스
class MyMyThreadInterruptEx extends JFrame {
    ...
    FillThread fillTH;
    MyConsumerThread consumeTH;


    public MyMyThreadInterruptEx() {
        setTitle("MyMyThreadInterruptEx 예제");
        ...
        runnable = new MyTimerRunnable(timerLabel);
